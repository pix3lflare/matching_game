...
class MatchingGame extends React.Component {
  ...
  timerInterval = () => {
    ...
    setInterval(() => {
      let decrementTimeBySecond = this.state.timeRemain - 1
      if(decrementTimeBySecond >= 0) {
        this.setState({
          timeRemain: decrementTimeBySecond
        })
        this.endGame();
      } else if (decrementTimeBySecond <=0 )
    }, 1000)
    ...
    return (
      <div className="matching-game">
        <div className="header">
          <Timer timeRemain={this.state.timeRemain} />
